  ...
  return (
    <html lang="en">
      <head>
        ...
        {/* Apple splash screens — portrait only, covers all modern devices */}
        ...
        <link rel="apple-touch-startup-image" href="/splash/splash-1640x2360.png" media="screen and (device-width: 820px) and (device-height: 1180px) and (-webkit-device-pixel-ratio: 2) and (orientation: portrait)" />
        <link rel="apple-touch-startup-image" href="/splash/splash-1620x2160.png" media="screen and (device-width: 810px) and (device-height: 1080px) and (-webkit-device-pixel-ratio: 2) and (orientation: portrait)" />
      </head>
      <body
